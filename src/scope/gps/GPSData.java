...
public class GPSData {
    ...
    public void setGpgga(String gpgga) {
        ...
        data = gpgga.split(",");
        if(isConnection()) {
            setAltitude(Double.valueOf(data[9]));
        }
    }
    ...
    public void setGprmc(String gprmc) {
    	//System.out.println("GPMRC = " + gprmc);
        this.gprmc = gprmc;
        data = gprmc.split(",");
    ...
    public String toString() {
        return "Time: "+ getTime() +"; Connected: " + isConnection() + "; Longitude: " + getLongitude() + "; Latitude: " + getLatitude() + "; Speed: " + getSpeed() + "; Altitude: " + getAltitude() + ";";
    }
}
