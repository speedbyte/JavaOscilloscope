        ...
        try
        {
            ...
            if (getChart().getPlot() instanceof Pannable)
            {
                ...
                if (panningPlot.isDomainPannable())
                {
                    ...
                    {
                        panningPlot.panDomainAxes(diffX, getChartRenderingInfo().getPlotInfo(),
                            startPoint);
                    }
                    else
                    {
                        panningPlot.panDomainAxes(diffY, getChartRenderingInfo().getPlotInfo(),
                            startPoint);
                    }
                }
                ...
                if (panningPlot.isRangePannable())
                {
                    if (panningPlot.getOrientation() == PlotOrientation.VERTICAL)
                    {
                        panningPlot.panRangeAxes(diffY, getChartRenderingInfo().getPlotInfo(),
                            startPoint);
                    }
                    else
                    {
                        panningPlot.panRangeAxes(diffX, getChartRenderingInfo().getPlotInfo(),
                            startPoint);
                    }
                }
            }
