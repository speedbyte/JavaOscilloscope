...
//	TODO split class in to WPAN class
	...
	private XBeeConfiguration xbee_conf = new XBeeConfiguration().withMaxQueueSize(100).withStartupChecks(false);
	
	private XBee xbee = new XBee(xbee_conf);
	...
	public ApiAtExample() throws XBeeException {
		...
		//	xbee.open("/dev/tty.usbserial-A4004Rim", 9600);
			xbee.open("COM15", 115200);
			
//			xbee.doStartupChecks();
